...
for i in range(5, 15):
    ...
    CMORPH_path = '/g/data/ua8/CMORPH/CMORPH_V1.0/netcdf/20{}/pr_30min_CMORPH_V1_20{}1201_20{}1231.nc'.format(
    ...
    save_path_CMORPH = '/g/data/w40/esh563/goulburn_NT/transects/CMORPH_goulburn_20{}12.nc'.format(str(i).zfill(2))
